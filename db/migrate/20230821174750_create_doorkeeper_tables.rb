...
class CreateDoorkeeperTables < ActiveRecord::Migration[7.0]
  def change
    ...
    # Access grants are used when a current user of the app needs to grant
    # permission to another app to read/write its data
    ...
    # Before executing the migration, you may want to add foreign keys to 
    # doorkeeper's tables to ensure data integrity. Uncomment the lines below:
